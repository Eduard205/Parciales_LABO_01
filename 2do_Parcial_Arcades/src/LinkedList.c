    ...
    Node *nuevoNode = NULL;
    	...
    	if (this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    	{
    		...
    		if (nuevoNode != NULL)
    		{
    			if (nodeIndex == 0)
    			{
    				nuevoNode->pNextNode = this->pFirstNode; //el primero lo mando al siguiente
    				this->pFirstNode = nuevoNode; //el nuevo lo mando al primero
...
int ll_remove(LinkedList* this,int index)
{
    int returnAux = -1;
    Node *anteriorNode = NULL;
    Node *auxNodoParaEliminar = NULL;

    	if (this != NULL && index >= 0 && index < ll_len(this))
    	{
    		auxNodoParaEliminar = getNode(this, index);

    		if (auxNodoParaEliminar != NULL)
    		{
    			if (index == 0)
    			{
    				this->pFirstNode = auxNodoParaEliminar->pNextNode;
    			...
    			}else
    				{
    					...
    					{
    						anteriorNode->pNextNode = auxNodoParaEliminar->pNextNode;
    					}
    				}
    		}

    			free(auxNodoParaEliminar); //free del nodo que quieres borrar
